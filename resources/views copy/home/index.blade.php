			...
			<div class="text-content white-font">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<video  class="embed-responsive-item "width="600" controls>
	  <source src="videos/holiday4change.mp4" type="video/mp4">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<!-- Image Box -->
					<a  class="img-box" data-background-image="images/popular1.jpeg">
				...
				<div class="col-md-8">
					...
					<!-- Image Box -->
					<a class="img-box" data-background-image="images/popular2.jpeg">
						<div class="img-box-content visible">
							<h4>Italy</h4>
						</div>
					</a>
				...
				<div class="col-md-8">
					...
					<!-- Image Box -->
					<a  class="img-box" data-background-image="images/popular3.jpeg">
						<div class="img-box-content visible">
							<h4>Gibraltar </h4>
						</div>
					</a>
				...
				<div class="col-md-4">
					...
					<!-- Image Box -->
					<a class="img-box" data-background-image="images/popular4.jpeg">
						<div class="img-box-content visible">
							<h4>Hawaii</h4>
						</div>
					</a>
