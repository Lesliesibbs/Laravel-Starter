...
class PlanController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('front-end.plan.index', compact('plan'));
    }
    /**
    ...
    public function subscribe(Request $request)
    {
        ...
        return redirect()->route('payments.index')->with('status', 'You are now subscribed to ' . $pickedPlan . ' plan.');
    }
    /**
    ...
    {
        return view('front-end.confirmation.index');
    }
    /**
    ...
    public function cancelSubscription(Request $request)
    {
        try {
            ...
            return redirect()->route('profile.index')->with('status', $e->getMessage());
        }
        return redirect()->route('profile.index')->with('status',
